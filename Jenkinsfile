    ...
    stages {
        ...
        stage('SonarQube analysis') {
            steps {
                ...
                sh "${scannerHome} -Dsonar.projectKey=python   -Dsonar.sources=.   -Dsonar.host.url=https://sonar.kishorereddy.tk   -Dsonar.login=3d9faad0dc57b404bcf5a97bca5a3c9ae3b7720f"
                } 
            }
        stage("Quality Gate") {
            steps {
